...
councilRoom = Card "Council Room" 5 [Action] [PlusDraw 4, PlusBuy 1, OthersPlusDraw 1]
...
moat = Card "Moat" 2 [Action, Reaction] [PlusDraw 2]
...
spy = Card "Spy" 4 [Action, Attack] [PlusDraw 1, PlusAction 1, SpyEffect]
...
witch = Card "Witch" 5 [Action, Attack] [PlusDraw 2, OthersGainCurse 1]
